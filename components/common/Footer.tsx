        ...
        <div className="mb-12 grid grid-cols-1 gap-10 md:grid-cols-4 lg:grid-cols-5">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="/blog" className="transition-colors hover:text-indigo-400">Blog</Link></li>
              <li><Link href="/careers" className="transition-colors hover:text-indigo-400">Careers</Link></li>
            </ul>
          </div>

          <div>
            <h4 className="mb-4 text-xs font-semibold uppercase tracking-wider text-slate-200">Legal</h4>
            <ul className="space-y-3">
              <li><Link href="/privacy" className="transition-colors hover:text-indigo-400">Privacy Policy</Link></li>
              <li><Link href="/terms" className="transition-colors hover:text-indigo-400">Terms of Service</Link></li>
              <li><Link href="/cookies" className="transition-colors hover:text-indigo-400">Cookie Policy</Link></li>
            </ul>
          </div>
        </div>
